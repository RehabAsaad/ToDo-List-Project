...
struct Task {
    ...
    /*
    يعتبر اهم فانشكن في الكود لان بيتم استدعائها في كل الفانكشنز
    لعرض تفاصيل التاسكات المتخزنة
    */
    void display() {
...
struct ToDoList {
    ...
    /*
    Delete a task
     فانكشن لحذف تاسك معين
     No tasks to delete! لو مفيش اي تاسك مضاف هيرجع
     لو فيه تاسكات متخزنة هيطلب من اليوزر يختار التاسك الذي يرغب في حذفه.
    ...
    */
    ...
    /*
    Display all tasks
    فانكشن لعرض تفاصيل التاسكات عن طريق استدعاء فانكشن العرض ل task struct
    ...
    */
    ...
    Mark a task as completed
     فانكشن لجعل التاسك مكتمل عن طريق عرض جميع التاسكات المتخزنة
     واليوزر يختار رقم التاسك الذي يريد ان يجعله مكتملا
    ...
    */
    ...
    /*
     Edit a task
     (Edit task) عند اختيار اليوزر اوبشن
      بيتم عرض جميع التاسكات المتخزنة
     واليوزر يبدا في اختيار رقم التاسك الذي يريد تعديله ويتم حفظه مجددا
    ...
    */
    ...
    Run the to-do list application
     فانكشن تشغيل البرنامج
     اولا: بيتم عرض قائمة الاختيارات
     1.Add Tasks:
     2.Delete Tasks:
     3.Display Tasks:
     4.Mark Task as Completed:
     5.Edit Task:
     6.Exit:
     عند اختيار اليوزر الرقم الذي يريده
     يتم استدعاء الفانكشن الممثلة لهذا الرقم وتنفيذها
